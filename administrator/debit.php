...
{  mysql_query("INSERT INTO transactions (cashier,type,paymentdate,charged,amount,paymentstat) VALUES ('$_SESSION[adminid]','Debit','$dt','$_REQUEST[custid]','$_REQUEST[amount]','active')");
